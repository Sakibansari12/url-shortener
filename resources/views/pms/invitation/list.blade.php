    ...
    <div class="container-fluid">
        <div class="title">
            <div class="row gx-2 align-items-center">
                <div class="col">
                    <h1 class="fs-5 mb-0">Invitation List</h1>
                </div>
                <div class="col-auto">
                    <a href="{{ route('pms.invitation.form') }}" class="btn d-flex btn-small rounded-2 btn-secondary">
        ...
        <div class="content-box p-3">
            <form method="GET" action="{{ route('pms.invitation.list') }}">
                @csrf
                <div class="row mb-3 g-3 flex-sm-row-reverse align-items-center">
                    <div class="col-sm-6 col-md-5 col-lg-4">
                        <div class="input-group input-group-sm">
                            ...
                            <a href="{{ route('pms.invitation.list') }}" class="btn btn-warning">
                ...
                <table class="table align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                             ...
                             <td>
                                <div class="position-relative">
                                    <button
                                        ...
                                        data-text="{{ url('/invite/accept/' . ($value->token ?? '')) }}"
                                        title="Copy">
                            ...
                            <td>
                                <ul class="actions">
                                    <!-- <li><a href="{{ route('pms.invitation.form', ['id'=>$value->id]) }}" class="btn btn-link"><i class="icon-edit"></i></a></li> -->
...
function copyToClipboard(button) {
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        $(document).on('click', '.item_delete', function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '{{ url("pms/invitation/delete") }}/' + id,
                        method: "DELETE",
                        headers: {
        ...
        $(".deleteSelected").click(function () {
            ...
            if (idArray.length > 0) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: '{{ url("pms/invitation/multidelete") }}',
                            method: 'POST',
                            data: { ids: idArray },
                            headers: {
                                'X-CSRF-TOKEN': $('meta[name="_token"]').attr('content')
        ...
        $('.btn_status').on('click', function () {
            ...
            $.ajax({
                url: '{{ url("pms/invitation/toggle-status") }}/' + id,
                type: 'PUT',
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="_token"]').attr('content')
                },
